...
/**
 * Coordinate math utilities for UV mapping: cylindrical, conical, spherical, and toroidal surfaces.
 * Extracted from PreviewUvMapper for code organization.
 */
public final class PreviewUvCoords {

    private PreviewUvCoords() {}

    // ─── Cylindrical coordinate math ────────────────────────────────────────
