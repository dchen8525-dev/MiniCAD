 ...
 * @param item annotated curve item
 */
public final class StepAnnotationCurveOccurrence implements StepEntity {
    private final int id;
    private final String name;
    private final List<StepPresentationStyleAssignment> styles;
    private final StepEntity item;

    public StepAnnotationCurveOccurrence(int id, String name, List<StepPresentationStyleAssignment> styles, StepEntity item) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        StepAnnotationCurveOccurrence that = (StepAnnotationCurveOccurrence) o;
    ...
    public String toString() {
        return "StepAnnotationCurveOccurrence{" + "id=" + id + "name=" + name + "styles=" + styles + "item=" + item + "}";
    }
}
