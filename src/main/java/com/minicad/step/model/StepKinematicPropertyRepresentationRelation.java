 ...
 * @param usedRepresentation referenced representation
 */
public final class StepKinematicPropertyRepresentationRelation implements StepEntity {
    private final int id;
    private final StepPropertyDefinition definition;
    private final StepRepresentation usedRepresentation;

    public StepKinematicPropertyRepresentationRelation(int id, StepPropertyDefinition definition, StepRepresentation usedRepresentation) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        StepKinematicPropertyRepresentationRelation that = (StepKinematicPropertyRepresentationRelation) o;
    ...
    public String toString() {
        return "StepKinematicPropertyRepresentationRelation{" + "id=" + id + "definition=" + definition + "usedRepresentation=" + usedRepresentation + "}";
    }
}
