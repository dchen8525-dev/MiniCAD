 ...
 * A revolute (hinge) kinematic pair allowing rotation about one axis.
 */
public final class StepRevolutePair implements StepEntity {
    ...
    public StepRevolutePair(int id, String name, String description, StepEntity position, StepEntity axis, StepEntity link1, StepEntity link2) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        StepRevolutePair that = (StepRevolutePair) o;
    ...
    public String toString() {
        return "StepRevolutePair{" + "id=" + id + "name=" + name + "description=" + description + "position=" + position + "axis=" + axis + "link1=" + link1 + "link2=" + link2 + "}";
    }
}
