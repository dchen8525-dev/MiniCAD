 ...
 * A revolute (rotational) joint between two links.
 */
public final class StepRevoluteJoint implements StepEntity {
    ...
    public StepRevoluteJoint(int id, String name, String description, StepEntity link1, StepEntity link2, StepEntity axis) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        StepRevoluteJoint that = (StepRevoluteJoint) o;
    ...
    public String toString() {
        return "StepRevoluteJoint{" + "id=" + id + "name=" + name + "description=" + description + "link1=" + link1 + "link2=" + link2 + "axis=" + axis + "}";
    }
}
