 ...
 * @param logStatus log variance status
 */
public final class StepTraceLog implements StepEntity {
    ...
    public StepTraceLog(int id, String name, String logType, List<StepEntity> logEntries, StepEntity logStartTime, StepEntity logEndTime, String logStatus) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        StepTraceLog that = (StepTraceLog) o;
    ...
    public String toString() {
        return "StepTraceLog{" + "id=" + id + "name=" + name + "logType=" + logType + "logEntries=" + logEntries + "logStartTime=" + logStartTime + "logEndTime=" + logEndTime + "logStatus=" + logStatus + "}";
    }
}