 ...
 * A prismatic (translational) joint between two links.
 */
public final class StepPrismaticJoint implements StepEntity {
    ...
    public StepPrismaticJoint(int id, String name, String description, StepEntity link1, StepEntity link2, StepEntity axis) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        StepPrismaticJoint that = (StepPrismaticJoint) o;
    ...
    public String toString() {
        return "StepPrismaticJoint{" + "id=" + id + "name=" + name + "description=" + description + "link1=" + link1 + "link2=" + link2 + "axis=" + axis + "}";
    }
}
