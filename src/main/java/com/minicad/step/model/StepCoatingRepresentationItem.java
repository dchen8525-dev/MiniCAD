 ...
 */
public final class StepCoatingRepresentationItem extends AbstractStepEntity {
    ...
    protected Map<String, Object> components() {
        ...
        state.put("coatingType", coatingType);
        state.put("coatingThickness", coatingThickness);
        state.put("coatingUnit", coatingUnit);
        state.put("coatingStatus", coatingStatus);
        return state;
    }
}
