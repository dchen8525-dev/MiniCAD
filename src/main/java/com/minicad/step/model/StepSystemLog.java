 ...
 * @param logStatus log variance status
 */
public final class StepSystemLog implements StepEntity {
    ...
    public StepSystemLog(int id, String name, String logType, List<StepEntity> logEntries, StepEntity logStartTime, StepEntity logEndTime, String logStatus) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        StepSystemLog that = (StepSystemLog) o;
    ...
    public String toString() {
        return "StepSystemLog{" + "id=" + id + "name=" + name + "logType=" + logType + "logEntries=" + logEntries + "logStartTime=" + logStartTime + "logEndTime=" + logEndTime + "logStatus=" + logStatus + "}";
    }
}