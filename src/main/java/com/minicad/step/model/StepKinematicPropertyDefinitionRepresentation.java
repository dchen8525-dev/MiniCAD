 ...
 * @param usedRepresentation referenced representation
 */
public final class StepKinematicPropertyDefinitionRepresentation implements StepEntity {
    private final int id;
    private final StepPropertyDefinition definition;
    private final StepRepresentation usedRepresentation;

    public StepKinematicPropertyDefinitionRepresentation(int id, StepPropertyDefinition definition, StepRepresentation usedRepresentation) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        StepKinematicPropertyDefinitionRepresentation that = (StepKinematicPropertyDefinitionRepresentation) o;
    ...
    public String toString() {
        return "StepKinematicPropertyDefinitionRepresentation{" + "id=" + id + "definition=" + definition + "usedRepresentation=" + usedRepresentation + "}";
    }
}
