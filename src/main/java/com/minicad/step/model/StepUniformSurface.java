...
/**
 * Resolved UNIFORM_SURFACE marker with inherited B-spline data when present.
 *
 ...
 */
public final class StepUniformSurface extends AbstractStepControlPointSurface {
    private final boolean uClosed;
    private final boolean vClosed;
    private final boolean selfIntersect;

    public StepUniformSurface(int id, String name, int uDegree, int vDegree, List<List<StepCartesianPoint>> controlPoints, String surfaceForm, boolean uClosed, boolean vClosed, boolean selfIntersect) {
    ...
    public boolean equals(Object o) {
        ...
        StepUniformSurface that = (StepUniformSurface) o;
    ...
    public String toString() {
        return "StepUniformSurface{" + "id=" + getId() + "name=" + getName() + "uDegree=" + getUDegree() + "vDegree=" + getVDegree() + "controlPoints=" + getControlPoints() + "surfaceForm=" + getSurfaceForm() + "uClosed=" + uClosed + "vClosed=" + vClosed + "selfIntersect=" + selfIntersect + "}";
    }
}
