...
/**
 * Resolved PIECEWISE_BEZIER_SURFACE marker with inherited B-spline data when present.
 *
 ...
 */
public final class StepPiecewiseBezierSurface extends AbstractStepControlPointSurface {
    private final boolean uClosed;
    private final boolean vClosed;
    private final boolean selfIntersect;

    public StepPiecewiseBezierSurface(int id, String name, int uDegree, int vDegree, List<List<StepCartesianPoint>> controlPoints, String surfaceForm, boolean uClosed, boolean vClosed, boolean selfIntersect) {
    ...
    public boolean equals(Object o) {
        ...
        StepPiecewiseBezierSurface that = (StepPiecewiseBezierSurface) o;
    ...
    public String toString() {
        return "StepPiecewiseBezierSurface{" + "id=" + getId() + "name=" + getName() + "uDegree=" + getUDegree() + "vDegree=" + getVDegree() + "controlPoints=" + getControlPoints() + "surfaceForm=" + getSurfaceForm() + "uClosed=" + uClosed + "vClosed=" + vClosed + "selfIntersect=" + selfIntersect + "}";
    }
}
