 ...
 * @param elements supported geometric elements
 */
public final class StepGeometricSet implements StepEntity {
    private final int id;
    private final String name;
    private final List<StepEntity> elements;

    public StepGeometricSet(int id, String name, List<StepEntity> elements) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        StepGeometricSet that = (StepGeometricSet) o;
    ...
    public String toString() {
        return "StepGeometricSet{" + "id=" + id + "name=" + name + "elements=" + elements + "}";
    }
}
