 ...
 * Properties associated with 3D curve/beam elements.
 */
public final class StepCurve3dElementProperty implements StepEntity {
    ...
    public boolean equals(Object o) {
        ...
        StepCurve3dElementProperty that = (StepCurve3dElementProperty) o;
    ...
    public String toString() {
        return "StepCurve3dElementProperty{" + "id=" + id + "name=" + name + "element=" + element + "property=" + property + "material=" + material + "}";
    }
}
