 ...
 * @param entryStatus entry variance status
 */
public final class StepWarningEntry implements StepEntity {
    ...
    public StepWarningEntry(int id, String name, String entryType, String entryCode, String entryMessage, int entrySeverity, StepEntity entryTimestamp, StepEntity entryContext, String entryStatus) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        StepWarningEntry that = (StepWarningEntry) o;
    ...
    public String toString() {
        return "StepWarningEntry{" + "id=" + id + "name=" + name + "entryType=" + entryType + "entryCode=" + entryCode + "entryMessage=" + entryMessage + "entrySeverity=" + entrySeverity + "entryTimestamp=" + entryTimestamp + "entryContext=" + entryContext + "entryStatus=" + entryStatus + "}";
    }
}