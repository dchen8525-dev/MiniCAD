 ...
 * @param logStatus log variance status
 */
public final class StepAuditLog implements StepEntity {
    ...
    public StepAuditLog(int id, String name, String logType, List<StepEntity> logEntries, StepEntity logStartTime, StepEntity logEndTime, String logStatus) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        StepAuditLog that = (StepAuditLog) o;
    ...
    public String toString() {
        return "StepAuditLog{" + "id=" + id + "name=" + name + "logType=" + logType + "logEntries=" + logEntries + "logStartTime=" + logStartTime + "logEndTime=" + logEndTime + "logStatus=" + logStatus + "}";
    }
}