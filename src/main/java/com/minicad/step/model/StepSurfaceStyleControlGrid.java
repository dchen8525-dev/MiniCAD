 ...
 * @param style referenced curve style
 */
public final class StepSurfaceStyleControlGrid implements StepEntity {
    ...
    public boolean equals(Object o) {
        ...
        StepSurfaceStyleControlGrid that = (StepSurfaceStyleControlGrid) o;
    ...
    public String toString() {
        return "StepSurfaceStyleControlGrid{" + "id=" + id + "style=" + style + "}";
    }
}
