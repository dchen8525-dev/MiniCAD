 ...
 * A general joint between two links.
 */
public final class StepGeneralJoint implements StepEntity {
    ...
    public boolean equals(Object o) {
        ...
        StepGeneralJoint that = (StepGeneralJoint) o;
    ...
    public String toString() {
        return "StepGeneralJoint{" + "id=" + id + "name=" + name + "description=" + description + "link1=" + link1 + "link2=" + link2 + "}";
    }
}
