 ...
 * @param selfIntersect self-intersection flag
 */
public final class StepUniformCurve implements StepEntity {
    ...
    public String toString() {
        return "StepUniformCurve{" + "id=" + id + "name=" + name + "degree=" + degree + "controlPoints=" + controlPoints + "curveForm=" + curveForm + "closedCurve=" + closedCurve + "selfIntersect=" + selfIntersect + "}";
    }
}
