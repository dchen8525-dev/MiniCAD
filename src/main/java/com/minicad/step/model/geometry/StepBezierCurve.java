 ...
 * @param selfIntersect self-intersection flag
 */
public final class StepBezierCurve implements StepEntity {
    ...
    public String toString() {
        return "StepBezierCurve{" + "id=" + id + "name=" + name + "degree=" + degree + "controlPoints=" + controlPoints + "curveForm=" + curveForm + "closedCurve=" + closedCurve + "selfIntersect=" + selfIntersect + "}";
    }
}
