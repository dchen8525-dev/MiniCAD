 ...
 * @param selfIntersect self-intersection flag
 */
public final class StepPiecewiseBezierSurface implements StepEntity {
    ...
    public String toString() {
        return "StepPiecewiseBezierSurface{" + "id=" + id + "name=" + name + "uDegree=" + uDegree + "vDegree=" + vDegree + "controlPoints=" + controlPoints + "surfaceForm=" + surfaceForm + "uClosed=" + uClosed + "vClosed=" + vClosed + "selfIntersect=" + selfIntersect + "}";
    }
}
