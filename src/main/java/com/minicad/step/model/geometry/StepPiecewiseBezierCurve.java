 ...
 * @param selfIntersect self-intersection flag
 */
public final class StepPiecewiseBezierCurve implements StepEntity {
    ...
    public String toString() {
        return "StepPiecewiseBezierCurve{" + "id=" + id + "name=" + name + "degree=" + degree + "controlPoints=" + controlPoints + "curveForm=" + curveForm + "closedCurve=" + closedCurve + "selfIntersect=" + selfIntersect + "}";
    }
}
