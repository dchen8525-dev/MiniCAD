 ...
 * @param usedRepresentation referenced representation
 */
public final class StepContactRatioRepresentation implements StepEntity {
    private final int id;
    private final StepPropertyDefinition definition;
    private final StepRepresentation usedRepresentation;

    public StepContactRatioRepresentation(int id, StepPropertyDefinition definition, StepRepresentation usedRepresentation) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        StepContactRatioRepresentation that = (StepContactRatioRepresentation) o;
    ...
    public String toString() {
        return "StepContactRatioRepresentation{" + "id=" + id + "definition=" + definition + "usedRepresentation=" + usedRepresentation + "}";
    }
}
