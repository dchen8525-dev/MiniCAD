...
/**
 * Resolved APPLICATION_LOG.
 * An application log entity.
 *
 ...
 * @param logStatus log variance status
 */
public final class StepApplicationLog implements StepEntity {
    ...
    public StepApplicationLog(int id, String name, String logType, List<StepEntity> logEntries, StepEntity logStartTime, StepEntity logEndTime, String logStatus) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        StepApplicationLog that = (StepApplicationLog) o;
    ...
    public String toString() {
        return "StepApplicationLog{" + "id=" + id + "name=" + name + "logType=" + logType + "logEntries=" + logEntries + "logStartTime=" + logStartTime + "logEndTime=" + logEndTime + "logStatus=" + logStatus + "}";
    }
}