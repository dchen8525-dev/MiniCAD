 ...
 * @param logStatus log variance status
 */
public final class StepPerformanceLog implements StepEntity {
    ...
    public StepPerformanceLog(int id, String name, String logType, List<StepEntity> logEntries, StepEntity logStartTime, StepEntity logEndTime, String logStatus) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        StepPerformanceLog that = (StepPerformanceLog) o;
    ...
    public String toString() {
        return "StepPerformanceLog{" + "id=" + id + "name=" + name + "logType=" + logType + "logEntries=" + logEntries + "logStartTime=" + logStartTime + "logEndTime=" + logEndTime + "logStatus=" + logStatus + "}";
    }
}