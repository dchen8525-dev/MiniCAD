 ...
 * @param usedRepresentation referenced representation
 */
public final class StepResourcePropertyRepresentation implements StepEntity {
    ...
    public boolean equals(Object o) {
        ...
        StepResourcePropertyRepresentation that = (StepResourcePropertyRepresentation) o;
    ...
    public String toString() {
        return "StepResourcePropertyRepresentation{" + "id=" + id + "definition=" + definition + "usedRepresentation=" + usedRepresentation + "}";
    }
}
