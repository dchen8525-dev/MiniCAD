 ...
 * Resolved FEA_2D_ELEMENT_PROPERTY.
 */
public final class StepFea2DElementProperty implements StepEntity {
    private final int id;
    private final String name;
    private final List<StepEntity> properties;
    private final StepEntity material;

    public StepFea2DElementProperty(int id, String name, List<StepEntity> properties, StepEntity material) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        StepFea2DElementProperty that = (StepFea2DElementProperty) o;
    ...
    public String toString() {
        return "StepFea2DElementProperty{" + "id=" + id + "name=" + name + "properties=" + properties + "material=" + material + "}";
    }
}
