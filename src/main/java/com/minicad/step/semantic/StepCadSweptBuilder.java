...
final class StepCadSweptBuilder {
    ...
    private CartesianPoint mapProfilePoint(StepProfileDef profile, Axis2Placement3D solidPlacement, Point2 point) {
        Point2 local = point;
        if (profile.getPosition() instanceof com.minicad.step.model.StepAxis2Placement2D) {
            com.minicad.step.model.StepAxis2Placement2D placement2D = (com.minicad.step.model.StepAxis2Placement2D) profile.getPosition();
